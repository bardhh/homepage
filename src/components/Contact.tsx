...
const Contact = () => {
  return (
    <section tabIndex={-1} id="contact" className="scroll-mt-24" role="region" aria-label="Contact information">
      ...
      <div className="glass rounded-2xl p-8 border border-white/40 dark:border-slate-700/40 shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:bardhh@gmail.com" className="text-slate-800 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium">
                    bardhh@gmail.com
                  </a>
                </div>
              </div>
          ...
          {/* Social Links */}
          <div className="flex flex-col justify-center items-center md:items-start border-t md:border-t-0 md:border-l border-slate-200/50 dark:border-slate-700/50 pt-8 md:pt-0 md:pl-8">
